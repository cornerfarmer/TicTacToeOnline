...
var drawX = function (x, y) {
    ctx.beginPath();
    ctx.moveTo(width / 3 * x + fieldBorder, height / 3 * y + fieldBorder);
    ctx.lineTo(width / 3 * (x + 1) - fieldBorder, height / 3 * (y + 1) - fieldBorder);
    ctx.closePath();
    ctx.stroke();

    ctx.beginPath();
    ctx.moveTo(width / 3 * (x + 1) - fieldBorder, height / 3 * y + fieldBorder);
    ctx.lineTo(width / 3 * x + fieldBorder, height / 3 * (y + 1) - fieldBorder);
    ctx.closePath();
    ctx.stroke();
}
...
var drawO = function (x, y) {
    ctx.beginPath();
    ctx.arc(width / 3 * (x + 0.5), height / 3 * (y + 0.5), height / 6 - 2 * fieldBorder, 0, 2 * Math.PI);
    ctx.closePath();
    ctx.stroke();
}
